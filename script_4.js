...
function underscoreSearcher(){
  console.log("underscore ====" + journaliste.toString().split('_').length)
}
underscoreSearcher()
...
// Quels sont les 50 handles les plus courts de cette array ?
  function shorter() {
  let jiad = journaliste.sort((a,b)=> a.length - b.length)
  console.log(jiad.slice(0,50));
};
shorter()
...
function penser(){
  // let search = 
  console.log(journaliste.indexOf('@epenser'))
}
penser()